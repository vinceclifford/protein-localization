...
Usage:
    python scripts/plot_all.py --sweep sweeps/<tag>
    python scripts/plot_all.py --csv path/to/results.csv --out path/to/dir
    python scripts/plot_all.py --sweep ... --zoom            # also produce zoomed
    python scripts/plot_all.py --sweep ... --paper-loc 76 --paper-meltome 0.65
"""
