...
def main() -> None:
    ...
    if all_rows:
        ...
        print(f'\nResults → {csv_path}')
        print(f'Plot    → python scripts/analysis/collect_results.py --runs-dir runs --out results/results.csv')
        print(f'          python scripts/analysis/plot_layers.py --csv results/results.csv')
